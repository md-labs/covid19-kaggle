...
1. Read the token embeddings generated by covid19-embeddings-simple-code.py in "word_embeddings/" folder.
2. Read the seed embeddings generated by covid19-embeddings-simple-code.py in "word_embeddings/" folder.
3. Read a file containing all the tokens present across all the abstracts from "inputs/" folder
...
word_embeddings/, inputs/ =======>  similar_words/
"""
